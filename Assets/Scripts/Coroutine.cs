...

{
    ...
    {
        GameObject[] players = GameObject.FindGameObjectsWithTag("Player");
        yield return new WaitUntil(() => Time.frameCount % 200 == 0); //Esperar a llegar a este numero de frames 2800
        ...
        players[3].GetComponent<Renderer>().material.color = UnityEngine.Color.yellow;
    }
